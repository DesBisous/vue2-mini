(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es6.object.get-own-property-names.js'), require('core-js/modules/es6.object.keys.js'), require('core-js/modules/es6.object.get-own-property-descriptor.js'), require('core-js/modules/es6.array.slice.js'), require('core-js/modules/es6.regexp.split.js'), require('core-js/modules/es6.object.to-string.js'), require('core-js/modules/es6.promise.js'), require('core-js/modules/es6.regexp.constructor.js'), require('core-js/modules/es6.regexp.match.js'), require('core-js/modules/es6.function.name.js'), require('core-js/modules/es6.array.map.js'), require('core-js/modules/es6.set.js'), require('core-js/modules/es6.string.iterator.js'), require('core-js/modules/es6.array.iterator.js'), require('core-js/modules/web.dom.iterable.js'), require('core-js/modules/es6.symbol.js'), require('core-js/modules/es6.array.from.js')) :
	typeof define === 'function' && define.amd ? define(['core-js/modules/es6.object.get-own-property-names.js', 'core-js/modules/es6.object.keys.js', 'core-js/modules/es6.object.get-own-property-descriptor.js', 'core-js/modules/es6.array.slice.js', 'core-js/modules/es6.regexp.split.js', 'core-js/modules/es6.object.to-string.js', 'core-js/modules/es6.promise.js', 'core-js/modules/es6.regexp.constructor.js', 'core-js/modules/es6.regexp.match.js', 'core-js/modules/es6.function.name.js', 'core-js/modules/es6.array.map.js', 'core-js/modules/es6.set.js', 'core-js/modules/es6.string.iterator.js', 'core-js/modules/es6.array.iterator.js', 'core-js/modules/web.dom.iterable.js', 'core-js/modules/es6.symbol.js', 'core-js/modules/es6.array.from.js'], factory) :
